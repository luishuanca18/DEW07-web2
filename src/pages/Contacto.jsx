    ...
    <div className="pagina-contacto">
      <main className="main-contacto">
        ...
        <section className="contenedor-contacto">
          ...
          <form  className="form-contacto-card" onSubmit={enviarMensaje}>
            <h2>Envíanos un mensaje</h2>
            <div className="form-grupo">
              <label htmlFor="nombre">Nombre completo</label>
              <input type="text" id="nombre" placeholder="Escribe aquí..." required />
            </div>
            <div className="form-grupo">
              <label htmlFor="email">Correo electrónico</label>
              <input type="email" id="email" placeholder="Escribe aquí..." required />
            </div>
            <div className="form-grupo">
          ...
          {mensajeEnviado && (
            ...
            <div className="fondo-mensaje-enviado">
              <div className="ventana-mensaje-enviado">
                ...
                <button type="button" onClick={cerrarMensaje}>
                  Aceptar
                </button>
              </div>
            </div>
